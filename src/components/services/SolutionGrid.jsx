...
const solutions = [
  ...
  },
  {
    ...
    description: 'Giám sát thời gian thực và tích hợp công nghệ điều khiển tối ưu hóa hiệu suất.',
    image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'
  },
  {
    title: 'Zero export',
    description: 'Tối ưu hiệu quả với đa cấp điều khiển, đảm bảo an toàn cho hệ thống',
  ...
  {
    title: 'Ổn định điện áp và tần số lưới',
