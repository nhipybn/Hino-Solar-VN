  ...
  const values = [
    {
      ...
      description: 'Giải pháp tích hợp toàn diện, bảo mật cao và khả năng mở rộng enterprise.',
    ...
    },
    {
      ...
      features: ['Giám sát chất lượng', 'Quản lý trên nền tảng sổ']
    }
  ];
    ...
    <section className="py-16 md:py-24 bg-white">
      <div className="container-custom">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 text-primary">Doanh nghiệp bạn đang gặp vấn đề gì?</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Hiểu rõ nhu cầu của từng đối tượng khách hàng, </p>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto" >chúng tôi tạo ra những tính năng phù hợp nhất
          </p>
        </div>
